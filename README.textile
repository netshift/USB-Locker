h2. Welcome to the home of USB-Locker. 

h3. A USB locking application coded in AutoIt 3.
...
Even though this technically application if not built for real security, I thought I'd add a capture for the hell of it. It's just a feature I'd been looking for an excuse to implement for a while now.
